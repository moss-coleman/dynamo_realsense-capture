...
def detectCharucoBoard(deviceManager, cameraSet, chessboardHeight, chessboardWidth, chessboardSquareSize):
    """ 
    ...
    charucoParams : dict
        dictionary of charuco board parameters

    Returns
    -------
    charucoboardLocations : dict
        dictionary with keys of camera's serial number holding detected individual markers, local 2D and 3D coordinates of detected corners, and their valid depth points
